...
def setup_browser(config_object) -> webdriver:
    ...
    new_browser = webdriver.Remote("http://chrome:4444/wd/hub", DesiredCapabilities.CHROME, options=options)
...
def download_data(browser_object: webdriver, config_object: configparser.ConfigParser) -> BeautifulSoup:
